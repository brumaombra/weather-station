                            ...
                            <div>
                                <div class="grid gap-y-4">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex">
                                            <input type="checkbox" v-model="viewModel.rememberMe" class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800">
                                        </div>
                                        <div class="ms-3">
