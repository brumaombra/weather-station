...
const createChart = () => {
    ...
    // Create chart
    const chartDom = document.getElementById('pm1LineChart'); // Get the DOM element
...
<template>
    <h3 class="mb-4 ms-3"><i class="fa-solid fa-hill-rockslide me-3 text-secondary"></i>PM1</h3>
