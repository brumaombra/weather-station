...
const createChart = () => {
    ...
    percentage = getPercentageDifference(measurements[0]?.pm10Avg, measurements[measurements.length - 1]?.pm10Avg);
};
...
<template>
    <div class="p-4 md:p-5 flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-500">
        ...
        <div class="flex justify-between items-center mb-3">
            <div>
                <h2 class="text-sm text-gray-500 dark:text-neutral-200">PM10</h2>
            </div>
            <div>
